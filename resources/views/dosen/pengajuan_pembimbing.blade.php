                ...
                <ul class="navbar-nav text-light" id="accordionSidebar-1">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu">
                            ...
                            <a class="dropdown-item active" href="/dosen/pengajuan_pembimbing">Pengajuan Pembimbing</a>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <div class="d-sm-flex justify-content-between align-items-center mb-4">
                        <h3 class="text-dark mb-0">Pengajuan Pembimbing</h3>
                    </div>
                    <div class="card shadow">
                        <div class="card-header py-3 d-flex justify-content-between align-items-center">
                            <p class="text-dark m-0 fw-bold">Data Pengajuan Pembimbing</p>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive table mt-2" id="dataTable-1" role="grid" aria-describedby="dataTable_info">
                                <table class="table table-striped table-hover" id="tableData">
                                    ...
                                    <tbody>
                                        @foreach ($menampilkanDataPengajuanPembimbing as $data)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                @if ($data->posisi == 'Pembimbing Satu')
                                                    <span class="badge rounded-pill bg-info me-1">Pembimbing 1</span>
                                                @else
                                                    <span class="badge rounded-pill bg-warning text-dark me-1">Pembimbing 2</span>
                                                @endif
                                            </td>
                                            <td class="text-center">
                                                ...
                                                @elseif ($data->status == 'Tidak Disetujui')
                                                    <span class="badge rounded-pill bg-danger">Tidak Disetujui</span>
                                                @elseif ($data->status == 'Menunggu Persetujuan')
                                                    <span class="badge rounded-pill text-dark bg-warning">Menunggu Persetujuan</span>
                                                @endif
                                            </td>
                                            <td>
                                                <p class="text-center">
                                                ...
                                                <button class="btn btn-danger btn-sm link-light" type="button" data-bs-toggle="modal" data-bs-target="#ModalRejectPembimbing{{$data->id}}">
                                                    ...
                                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h5 class="modal-title">Konfirmasi Pengajuan Pembimbing</h5><button class="btn-close" type="button" aria-label="Close" data-bs-dismiss="modal"></button>
                                                            </div>
                                                            ...
                                                            <div class="modal-footer">
                                                                <button class="btn btn-secondary btn-sm" type="button" data-bs-dismiss="modal"><i class="fas fa-times"></i>&nbsp;Batalkan</button>
                                                                <a href="{{ route('pengajuan_pembimbing.acc', $data->id) }}" class="btn btn-sm" type="button" style="background: #881d1d;color: rgb(255,255,255);"><i class="fas fa-check"></i>&nbsp;Ya, Yakin</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="modal fade" role="dialog" tabindex="-1" id="ModalRejectPembimbing{{$data->id}}">
                                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h5 class="modal-title">Konfirmasi Pengajuan Pembimbing</h5><button class="btn-close" type="button" aria-label="Close" data-bs-dismiss="modal"></button>
